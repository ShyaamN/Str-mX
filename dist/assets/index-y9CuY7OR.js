var ol=Object.defineProperty;var al=(i,t,e)=>t in i?ol(i,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):i[t]=e;var Z=(i,t,e)=>al(i,typeof t!="symbol"?t+"":t,e);(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))n(r);new MutationObserver(r=>{for(const s of r)if(s.type==="childList")for(const a of s.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&n(a)}).observe(document,{childList:!0,subtree:!0});function e(r){const s={};return r.integrity&&(s.integrity=r.integrity),r.referrerPolicy&&(s.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?s.credentials="include":r.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function n(r){if(r.ep)return;r.ep=!0;const s=e(r);fetch(r.href,s)}})();function ll(i,t){var p,f;if(!document.getElementById("collapsible-style")){const g=document.createElement("style");g.id="collapsible-style",g.textContent=`
  ...
  }`;this.progVortForce=n(r,_);const y=`#version 300 es
  precision highp float; in vec2 uv; out vec4 o; uniform sampler2D vel; uniform sampler2D mask; uniform vec2 px;
  void main(){
    float m = texture(mask, uv).r;
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:mn,depthTest:!1,depthWrite:!1})}function Oo(){return new Nn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Ms(),fragmentShader:`
		...
		`,blending:mn,depthTest:!1,depthWrite:!1})}function Bo(){return new Nn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ms(),fragmentShader:`
...
</div>`;let Un=document.getElementById("glcanvas");const zp=document.getElementById("sidebar"),is=document.getElementById("console"),li=document.getElementById("overlay"),Me=document.createElement("canvas");Me.id="legend";Me.width=220;Me.height=42;Me.style.position="absolute";Me.style.bottom="12px";Me.style.right="12px";Me.style.background="#0b1220cc";Me.style.border="1px solid #1f2a3a";Me.style.borderRadius="8px";Me.style.padding="6px 8px";Me.style.zIndex="15";li.appendChild(Me);const Se=document.createElement("div");Se.id="navCube";Se.style.position="absolute";Se.style.top="10px";Se.style.right="10px";Se.style.width="70px";Se.style.height="70px";Se.style.background="#0b1220cc";Se.style.border="1px solid #1f2a3a";Se.style.borderRadius="8px";Se.style.display="grid";Se.style.gridTemplateRows="1fr auto";Se.style.zIndex="25";Se.style.userSelect="none";Se.style.pointerEvents="auto";Se.innerHTML='<canvas id="navCanvas" width="70" height="50"></canvas><div style="display:flex;gap:6px;justify-content:center;padding:4px"><button id="homeView" class="btn ghost" style="padding:4px 8px">Home</button><label style="display:flex;align-items:center;gap:6px;color:#8da2b5;font-size:12px"><input id="gridToggle" type="checkbox" checked/> Grid</label></div>';li.appendChild(Se);let Si;function Ja(){Si&&(cancelAnimationFrame(Si),Si=void 0)}function ur(i,t){const e=document.getElementById("navCanvas");if(!e)return;const n=e.getContext("2d");if(n.clearRect(0,0,e.width,e.height),i==="3d"){if(n.lineWidth=1.2,n.strokeStyle="#4ea0ff",n.fillStyle="#173152",n.beginPath(),n.moveTo(21,12),n.lineTo(49,12),n.lineTo(55,6),n.lineTo(27,6),n.closePath(),n.fill(),n.stroke(),n.fillStyle="#132239",n.beginPath(),n.rect(21,12,2*14,2*14),n.fill(),n.stroke(),n.fillStyle="#112034",n.beginPath(),n.moveTo(49,12),n.lineTo(55,6),n.lineTo(55,34),n.lineTo(49,40),n.closePath(),n.fill(),n.stroke(),n.fillStyle="#8da2b5",n.font="10px ui-monospace, monospace",n.textAlign="center",n.fillText("3D",35,11),t){const o=t.phi,l=t.theta,c=Math.sin(o)*Math.sin(l),h=Math.cos(o),d=Math.sin(o)*Math.cos(l),u=Math.abs(c),m=Math.abs(h),v=Math.abs(d);let x="FRONT",p="#4ea0ff";v>=u&&v>=m?x=d>=0?"FRONT":"BACK":u>=m?x=c>=0?"RIGHT":"LEFT":x=h>=0?"TOP":"BOTTOM";const f=46,g=12,_=35-f/2,y=5;n.fillStyle="#0f1e34",n.strokeStyle=p,n.lineWidth=1,n.beginPath(),n.roundRect(_,y,f,g,4),n.fill(),n.stroke(),n.fillStyle="#bcd1e6",n.font="9px ui-monospace, monospace",n.fillText(x,35,y+9.5)}}else n.strokeStyle="#48e3b7",n.fillStyle="#122a23",n.lineWidth=1.5,n.strokeRect(15,10,40,30),n.fillRect(15,10,40,30),n.fillStyle="#8da2b5",n.font="10px ui-monospace, monospace",n.textAlign="center",n.fillText("2D",35,11)}ur("3d");document.getElementById("homeView").addEventListener("click",()=>{var i,t;Et&&((i=Et.resetView)==null||i.call(Et)),qt&&((t=qt.resetView)==null||t.call(qt))});const nr=document.getElementById("gridToggle");nr==null||nr.addEventListener("change",()=>{var i;Et&&((i=Et.setGridVisible)==null||i.call(Et,nr.checked))});const vr=document.getElementById("navCanvas");let bs=!1,rr=[0,0];vr.addEventListener("pointerdown",i=>{bs=!0,i.currentTarget.setPointerCapture(i.pointerId),rr=[i.clientX,i.clientY]});vr.addEventListener("pointermove",i=>{var n;if(!bs||!Et)return;const t=i.clientX-rr[0],e=i.clientY-rr[1];rr=[i.clientX,i.clientY],(n=Et.orbitBy)==null||n.call(Et,t,e)});vr.addEventListener("pointerup",i=>{var t,e;bs=!1,(e=(t=i.currentTarget).releasePointerCapture)==null||e.call(t,i.pointerId)});vr.addEventListener("click",i=>{var r,s,a,o;if(!Et)return;const t=i.currentTarget.getBoundingClientRect(),e=(i.clientX-t.left)/t.width;(i.clientY-t.top)/t.height<.35?(r=Et.setView)==null||r.call(Et,"top"):e<.33?(s=Et.setView)==null||s.call(Et,"left"):e>.66?(a=Et.setView)==null||a.call(Et,"right"):(o=Et.setView)==null||o.call(Et,"front")});function kp(i){i=Math.max(0,Math.min(1,i));const t=34.61+i*(1172.33+i*(-10793.56+i*(33300.12+i*(-38394.49+i*14825.05)))),e=23.31+i*(557.33+i*(1225.33+i*(-3574.96+i*(3481.96-i*1108.04)))),n=27.2+i*(321.21+i*(-1525.77+i*(2815.57+i*(-1904.75+i*348.02)))),r=Math.round(t/255),s=Math.round(e/255),a=Math.round(n/255);return`rgb(${r}, ${s}, ${a})`}function aa(i,t,e){return i+(t-i)*e}window.updateLegend=function(i){const t=Me.getContext("2d"),e=Me.width,n=Me.height;t.clearRect(0,0,e,n);const r=(v,x,p)=>{t.fillStyle="#dce6f2",t.font="11px ui-monospace, monospace",t.textAlign="center",t.fillText(v,x,p)},s=10,a=18,o=e-20,l=10;t.fillStyle="#0b1220",t.fillRect(0,0,e,n);const c=document.querySelector("#overlayVis"),h=i||(c==null?void 0:c.value)||"dye";for(let v=0;v<o;v++){const x=v/(o-1);let p="white";if(h==="velocity")p=kp(x);else if(h==="pressure"){const f=aa(-1,1,x),g=.5+.5*f,_=.5-.5*f,y=1-Math.abs(f);p=`rgb(${Math.round(g*255)},${Math.round(_*255)},${Math.round(y*255)})`}else if(h==="vorticity"){const f=aa(-1,1,x),g=.5+.5*f,_=.5-.5*f,y=1-Math.abs(f);p=`rgb(${Math.round(g*255)},${Math.round(_*255)},${Math.round(y*255)})`}else if(h==="streamlines"){const f=Math.round(x*255);p=`rgb(${f},${f},${f})`}t.fillStyle=p,t.fillRect(s+v,a,1,l)}t.fillStyle="#dce6f2",t.font="12px ui-monospace, monospace",t.textAlign="left";let d="0",u="1",m="";if(h==="velocity")d="0",u="|v|",m="Velocity";else if(h==="pressure"){const v=document.getElementById("pScale"),x=v?parseFloat(v.value):1;d=`-${x.toFixed(1)}`,u=`+${x.toFixed(1)}`,m="Pressure"}else h==="vorticity"?(d="-1",u="+1",m="Vorticity"):h==="streamlines"&&(d="0",u="1",m="Streamlines");t.fillText(m,s,12),r(d,s,a+l+14),r(u,s+o,a+l+14),Me.style.display=h==="dye"?"none":"block"};let qt=null,Et=null,rn=null;function Wt(i){is.textContent=(is.textContent?is.textContent+`
`:"")+i}window.appLog=Wt;function As(){const i=Math.min(2,window.devicePixelRatio||1),t=Un.getBoundingClientRect(),e=Math.floor(t.width*i),n=Math.floor(t.height*i);Wt(`Resize called: rect=${t.width}x${t.height}, dpr=${i}, canvas size=${e}x${n}`),Un.width=e,Un.height=n,qt&&(Wt(`Calling engine2d.resize(${e}, ${n}, ${i})`),qt.resize(e,n,i)),Et&&(Wt(`Calling engine3d.resize(${e}, ${n}, ${i})`),Et.resize(e,n,i))}window.addEventListener("resize",As);function Qa(){Wt("recreateCanvas() called");const i=document.getElementById("viewport"),t=document.getElementById("glcanvas");t&&(Wt("Removing old canvas"),i.removeChild(t));const e=document.createElement("canvas");e.id="glcanvas",e.style.position="absolute",e.style.inset="0",e.style.width="100%",e.style.height="100%",e.style.zIndex="1",i.insertBefore(e,document.getElementById("overlay")),Un=e,Wt(`New canvas created with id=${Un.id}`)}function Vp(){var i,t,e,n;Wt("start2D() called - beginning 2D mode initialization");try{Et==null||Et.dispose(),Et=null,Ja(),rn&&(rn.dispose(),rn=null),Wt("start2D() - disposed 3D engine, recreating canvas"),Qa(),Wt("start2D() - creating new 2D engine"),qt=new cl(Un,li,Wt,o=>{const l=document.getElementById("fps");l&&(l.textContent=`${o.toFixed(0)} fps`)},o=>Gp(o)),Wt("start2D() - starting 2D engine"),qt.start(),Wt("start2D() - resizing canvas"),As(),Wt("start2D() - adding default circle"),qt.addCircle(),Wt("start2D() - setting tool and view"),(i=qt.setTool)==null||i.call(qt,"draw"),(t=qt.resetView)==null||t.call(qt),Wt("start2D() - setting overlay mode");try{const o=document.querySelector("#overlayVis");o&&(o.value="dye"),(e=qt.setOverlayMode)==null||e.call(qt,"dye")}catch(o){Wt("Error setting overlay mode: "+o)}Wt("start2D() - updating UI");const r=document.querySelector("#draw"),s=document.querySelector("#select");r&&s&&(r.classList.add("active"),s.classList.remove("active")),(n=window.updateLegend)==null||n.call(window),ur("2d"),Wt("start2D() - creating mode badge");let a=document.getElementById("modeBadge");a||(a=document.createElement("div"),a.id="modeBadge",a.style.position="absolute",a.style.top="10px",a.style.left="10px",a.style.zIndex="99",a.style.background="#0b1220cc",a.style.border="1px solid #1f2a3a",a.style.borderRadius="8px",a.style.padding="4px 8px",a.style.color="#8da2b5",li.appendChild(a)),a.textContent="2D MODE",Wt("Entered 2D mode"),document.dispatchEvent(new CustomEvent("fluidsim-2d-ready")),Wt("start2D() - initialization complete")}catch(r){Wt("ERROR in start2D(): "+r),console.error("start2D() error:",r)}}function tl(){qt==null||qt.dispose(),qt=null,Qa(),Et=new Np(Un,n=>{const r=document.getElementById("fps");r&&(r.textContent=`${n.toFixed(0)} fps`)}),Et.start(),As(),ur("3d"),Wt("Entered 3D mode");let i=document.getElementById("modeBadge");i||(i=document.createElement("div"),i.id="modeBadge",i.style.position="absolute",i.style.top="10px",i.style.left="10px",i.style.zIndex="99",i.style.background="#0b1220cc",i.style.border="1px solid #1f2a3a",i.style.borderRadius="8px",i.style.padding="4px 8px",i.style.color="#8da2b5",li.appendChild(i)),i.textContent="3D MODE";const t=()=>{var r;if(!Et)return;const n=(r=Et.getSpherical)==null?void 0:r.call(Et);ur("3d",n),Si=requestAnimationFrame(t)};Ja(),Si=requestAnimationFrame(t),rn&&(rn.dispose(),rn=null),rn=new Fp(li,n=>{var r;(r=Et.setView)==null||r.call(Et,n)},(n,r)=>{var s;(s=Et.orbitBy)==null||s.call(Et,n,r)});const e=()=>{var r;if(!Et||!rn)return;const n=(r=Et.getCameraQuat)==null?void 0:r.call(Et);n&&rn.setOrientation(n),requestAnimationFrame(e)};requestAnimationFrame(e)}function Gp(i){document.getElementById("re").textContent=i.Re.toFixed(0),document.getElementById("cd").textContent=i.Cd.toFixed(3),document.getElementById("cl").textContent=i.Cl.toFixed(3),document.getElementById("dp").textContent=i.dP.toFixed(2)}ll(zp,{onMode:i=>{Wt(`Mode switch triggered: ${i}`),i==="2d"?(Wt("Calling start2D()"),Vp()):(Wt("Calling start3D()"),tl())},get2d:()=>qt});const la=document.getElementById("saveScene");la&&la.addEventListener("click",()=>{const i=document.getElementById("overlay"),t=Array.from((i==null?void 0:i.querySelectorAll(".annotation"))||[]).map(o=>({type:o.classList.contains("label")?"label":o.classList.contains("arrow")?"arrow":"text",text:o.textContent,left:o.style.left,top:o.style.top,width:o.style.width,height:o.style.height}));let e=null;qt&&qt.saveScene&&(e=JSON.parse(qt.saveScene()));const n=JSON.stringify({...e,annotations:t}),r=new Blob([n],{type:"application/json"}),s=URL.createObjectURL(r),a=document.createElement("a");a.href=s,a.download="fluidsim_scene.json",document.body.appendChild(a),a.click(),document.body.removeChild(a),setTimeout(()=>URL.revokeObjectURL(s),500)});const ca=document.getElementById("loadScene"),rs=document.getElementById("loadFile");ca&&rs&&(ca.addEventListener("click",()=>{rs.click()}),rs.addEventListener("change",i=>{const t=i.target.files[0];if(!t)return;const e=new FileReader;e.onload=()=>{const n=e.result;let r=null;try{r=JSON.parse(n)}catch{}qt&&qt.loadScene&&r&&r.obstacles&&qt.loadScene(n);const s=document.getElementById("overlay");if(s&&Array.from(s.querySelectorAll(".annotation")).forEach(a=>a.remove()),r&&Array.isArray(r.annotations)&&s)for(const a of r.annotations){const o=document.createElement("div");o.className="annotation "+a.type,o.contentEditable=a.type!=="arrow"?"true":"false",o.style.position="absolute",o.style.left=a.left,o.style.top=a.top,o.style.width=a.width,o.style.height=a.height,o.style.color="#fff",o.style.background=a.type==="arrow"?"none":"rgba(20,30,50,0.7)",o.style.borderRadius="6px",o.style.padding=a.type==="arrow"?"0":"4px 10px",o.style.fontSize="18px",o.style.cursor="move",o.style.userSelect="text",o.style.zIndex="10",o.draggable=!0,a.type==="arrow"?(o.innerHTML='<svg width="60" height="24"><line x1="8" y1="12" x2="52" y2="12" stroke="#fff" stroke-width="3" marker-end="url(#arrowhead)"/><defs><marker id="arrowhead" markerWidth="8" markerHeight="8" refX="8" refY="4" orient="auto" markerUnits="strokeWidth"><path d="M0,0 L8,4 L0,8 L2,4 Z" fill="#fff"/></marker></defs></svg>',o.contentEditable="false",o.style.pointerEvents="auto",o.style.background="none",o.style.padding="0"):o.textContent=a.text;let l=0,c=0;o.addEventListener("dragstart",h=>{l=h.offsetX,c=h.offsetY}),o.addEventListener("dragend",h=>{o.style.left=h.pageX-s.offsetLeft-l+"px",o.style.top=h.pageY-s.offsetTop-c+"px"}),o.addEventListener("dblclick",()=>o.remove()),s.appendChild(o),a.type!=="arrow"&&o.focus()}},e.readAsText(t)}));tl();setTimeout(()=>{Wt("AUTO TEST: Forcing 2D mode after 2 seconds");try{const i=document.querySelector("#modeSwitch");i?(Wt("AUTO TEST: Found mode switch, triggering change to 2D"),i.checked=!1,i.dispatchEvent(new Event("change"))):Wt("AUTO TEST: Mode switch not found!")}catch(i){Wt("AUTO TEST ERROR: "+i)}},2e3);
